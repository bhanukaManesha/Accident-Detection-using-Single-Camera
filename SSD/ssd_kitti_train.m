function ssd_kitti_train(varargin)
...
%   opts.dataOpts.dataRoot = fullfile(vl_rootnn, 'data', 'datasets') ;
  opts.dataOpts.dataRoot = '/Users/bhanuka/Documents/GitHub.nosync/SSD/kitti_dataset/';
  ...
  batchOpts.useGpu = false ;
  batchOpts.resizeMethods = {'bilinear', 'box', 'nearest', 'bicubic', 'lanczos2'} ;

  % determine experiment name
  expName = "ssd_kitti_dataset";
  expDir = fullfile(vl_rootnn, 'data', opts.dataOpts.name, expName) ;

  % configure paths
  opts.dataOpts.imdbPath = fullfile(opts.dataOpts.dataRoot, 'standard_imdb/imdb.mat') ;
